...
ai = AIPongOpponent(game.right_paddle.y, game.right_paddle.y, game.ball.x, game.ball.y, game.ball.x_vel, game.ball.y_vel, game.right_paddle.VEL, game.right_paddle.HEIGHT, 10)
