		...
		for (var tournament_id in tournaments_info) {
			((id) => {
				...
				joinButton.addEventListener('click', () => {
					...
					this.ws.send(JSON.stringify({type: 'lobby_update', 'action': 'join_tournament',
